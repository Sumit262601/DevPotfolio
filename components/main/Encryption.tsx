...
const Encryption = () => {
  return (
    <div className="flex flex-row relative items-center justify-center min-h-screen w-full h-full">
      <div className="absolute w-auto h-auto top-0 z-[5] text-center">
        <motion.div
          variants={slideInFromTop}
          className="text-[40px] md:text-[60px] font-medium text-gray-200 cursive"
        >
          Performance
      ...
      <div className="absolute z-[20] bottom-2 px-2 text-center">
