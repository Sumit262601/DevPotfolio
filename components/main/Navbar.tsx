    ...
    <div className="w-full h-[65px] fixed top-0 shadow-lg shadow-[#2A0E61]/50 bg-[#03001417] backdrop-blur-md z-50 px-5 md:px-10">
      <div className="w-full h-full flex flex-row items-center justify-between m-auto px-2">
        ...
        >
          ...
          />
          <span className="font-bold ml-2 md:ml-3 md:block text-gray-300">
            Sumit Kumar
          </span>
        </a>

        <div className="hidden md:flex w-auto h-full items-center justify-between md:mr-20">
          <div className="flex items-center justify-between w-full h-auto border border-[#7042f861] bg-[#0300145e] px-4 py-2 rounded-full text-gray-200 space-x-4">
            ...
            <a href="#certificate" className="cursor-pointer">
              Certifications
            </a>
          </div>
        </div>
